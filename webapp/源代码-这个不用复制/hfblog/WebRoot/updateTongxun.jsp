...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<![endif]-->
<% Tongxun user = (Tongxun)request.getAttribute("upuser"); 
	if(user==null){
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					...
					<!-- Start Sign In Form -->
					<form action="/hfblog/UpdateTongxun" method="post" class="fh5co-form animate-box" data-animate-effect="fadeInLeft">
						<h2>Modify</h2>
						...
						<div class="form-group">
							<label for="password" class="sr-only">Work</label>
							<input type="text" value="${upuser.work }" name="work" class="form-control" id="name" placeholder="work" autocomplete="off">
						</div>
