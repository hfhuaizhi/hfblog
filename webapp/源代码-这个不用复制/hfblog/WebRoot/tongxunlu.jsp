...
<div class="alert alert-danger alert-dismissable">
   ...
   <%} 
    request.removeAttribute("erroradd");
   %>
    <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a data-toggle="modal" data-target="#addUser">增加联系人</a></li>
        </ol>
        <h1 class="page-header">管理通讯录<span class="badge">2</span></h1>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-tree-deciduous"></span> <span class="visible-lg">工作单位</span></th>
                <th><span class="glyphicon glyphicon-pencil"></span> <span class="visible-lg">操作</span></th>
              </tr>
            </thead>
            <tbody>
            <c:forEach items="${tongxunlist }" var="b">
										<tr>
                <td>${b.id }</td>
                <td>${b.name }</td>
                <td>${b.phone }</td>
                <td>${b.email }</td>
                <td>${b.work }</td>
                <td><!-- <a data-toggle="modal" data-target="#WeChat">帮助</a> --><a  href="/hfblog/UpdateSetTongxun?username=${b.id}">修改</a> <a rel="${b.id }" name="delete">删除</a> <a href="">禁用</a></td>
              </tr>
									</c:forEach>	
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="/hfblog/AddTongxun" method="post" autocomplete="off" draggable="false">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" >增加联系人</h4>
        </div>
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">电话:</td>
                <td width="80%"><input type="text"  class="form-control" name="phone" maxlength="11" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">邮箱:</td>
                <td width="80%"><input type="email"  class="form-control" name="email" maxlength="30" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">工作单位:</td>
                <td width="80%"><input  type="text" class="form-control" name="work" maxlength="50" autocomplete="off" /></td>
              </tr>
