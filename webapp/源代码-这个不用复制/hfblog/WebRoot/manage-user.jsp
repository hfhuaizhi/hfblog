        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
			...
			<tr>
                ...
                <td><!-- <a data-toggle="modal" data-target="#WeChat">帮助</a> --><a  href="/hfblog/UpdateSetUser?username=${b.username}">修改</a> <a rel="${b.id }" name="delete">删除</a> <a href="">禁用</a></td>
              </tr>
			</c:forEach>	
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="/hfblog/AddUser" method="post" autocomplete="off" draggable="false">
